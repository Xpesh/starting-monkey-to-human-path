...
//        codebaseUrl = "file://".concat(preferencesManager.getProperty(PreferencesManagerConstants.classprovider));//берет путь из конфига
    ...
    public static void test(XmlDataManager xmlDataManager) throws NotFoundException, RemoteException, TransformerException {
        ...
        while (true){
            ...
            switch (scanner.next()){
                case "setTariff" :         xmlDataManager.setTariff("coldwater",40); break;
                case "addRegistration" :   xmlDataManager.addRegistration(building,2,registration,1,2005);break;
                case "getBill" :         System.out.println(xmlDataManager.getBill(building,2,2,2002));break;
                case "exit" : System.exit(0);
                default:
                    System.out.println("case \"setTariff\" :         xmlDataManager.setTariff(\"coldwater\",40); break;\n" +
                            "                case \"addRegistration\" :   xmlDataManager.addRegistration(building,2,registration,1,2005);break;\n" +
                            "                case \"getBill\" :         System.out.println(xmlDataManager.getBill(building,2,2,2002));break;\n" +
                            "                case \"exit\" : System.exit(0);");
            }
